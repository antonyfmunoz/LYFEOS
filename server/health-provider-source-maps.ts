...
export const reviewedHealthProviderSourceMaps = {
  ...
  oura: {
    ...
    entries: [
      ...
      { sourceMetricId: "PublicWorkout.calories", canonicalMetricKey: "active_energy", adapterUnit: "kcal", temporalType: "interval", extraction: "provider workout calories in kilocalories over the exact workout interval" },
      { sourceMetricId: "PublicWorkout.distance", canonicalMetricKey: "distance", adapterUnit: "m", temporalType: "interval", extraction: "provider workout distance in meters over the exact workout interval; no route is retained" },
      ...
      { sourceMetricId: "PublicModifiedSleepModel.average_heart_rate", canonicalMetricKey: "heart_rate", adapterUnit: "bpm", temporalType: "interval", extraction: "provider-calculated average heart rate over the named sleep interval, distinct from discrete samples" },
