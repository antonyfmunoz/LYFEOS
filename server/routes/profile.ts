...
const accountExportTables = [
  ...
  "widget_states", "user_activity_events", "smart_reminders", "mission_views", "push_subscriptions", "ai_orchestration_steps", "ai_orchestration_runs", "ai_voice_session_segments", "ai_voice_sessions", "ai_pending_actions", "ai_action_records", "ai_action_repairs", "ai_context_receipts", "ai_memory_policies", "ai_persona_profiles",
...
export async function deleteLocalAccountData(userId: number): Promise<void> {
  await db.transaction(async (tx) => {
    ...
    for (const table of [
      ...
      "finance_balance_snapshots", "finance_transactions", "finance_budgets", "finance_goals", "finance_accounts",
