...
describe("production browser acceptance custody", () => {
  ...
  it("qualifies the rendered truthful Mission loop separately and always archives its synthetic record", () => {
    ...
    expect(coreLoopScript).toContain('page.click(\'[data-testid="automation-create"]\')');
    expect(coreLoopScript).toContain('page.click(\'[data-testid="automation-save"]\')');
    expect(coreLoopScript).toContain('page.click(\'[data-testid="automation-preview"]\')');
    ...
    expect(coreLoopScript).toContain('page.click(\'[data-testid="automation-delete"]\')');
