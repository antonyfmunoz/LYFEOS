...
describe("Canvas instrument", () => {
  ...
  it("recognizes the static new-canvas route and exposes stable production acceptance seams", () => {
    ...
    expect(editor).toContain('data-testid="canvas-templates"');
    expect(editor).toContain('data-testid="canvas-template-apply"');
    expect(editor).toContain('data-testid="canvas-import-confirm"');
    expect(editor).toContain('data-testid="canvas-undo"');
    expect(editor).toContain('data-testid="canvas-redo"');
