...
export const LYFEOS_DATA_CLASSES: readonly LyfeOSDataClass[] = [
  ...
  },
  {
    ...
    examples: ["connection status", "consent scopes", "sync state", "UMH commands", "outbox receipts", "work links", "signed extension installation and permission receipts"],
