...
import { AlertTriangle, ArrowLeft, Play, Plus, RotateCcw, Save, ShieldCheck, Trash2, Workflow } from "lucide-react";
import {
...
export default function AutomationsPage() {
  ...
  return <div data-testid="automations-page" className="container max-w-6xl space-y-5 py-6">
    ...
    <div className="flex flex-wrap items-start justify-between gap-3">
      ...
      <Button data-testid="automation-create" onClick={() => create.mutate()} disabled={create.isPending || (list.data?.automations.length || 0) >= 25}><Plus className="mr-1 h-4 w-4" />New automation</Button>
    </div>
