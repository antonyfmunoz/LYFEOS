...
export default function AutomationsPage() {
  ...
  return <div className="container max-w-6xl space-y-5 py-6">
    <div className="flex flex-wrap items-start justify-between gap-3">
      ...
      <div className="flex gap-2"><Button asChild variant="outline"><Link href="/document-vault">Data Vault</Link></Button><Button onClick={() => create.mutate()} disabled={create.isPending || (list.data?.automations.length || 0) >= 25}><Plus className="mr-1 h-4 w-4" />New automation</Button></div>
    </div>
