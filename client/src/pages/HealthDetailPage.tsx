...
export default function HealthDetailPage() {
  ...
  const healthPct = stats.healthPoints.max > 0 ? Math.round((stats.healthPoints.current / stats.healthPoints.max) * 100) : 0;
  ...
  const healthMetrics = [
    { name: "Activity Level", score: activityScore, icon: Target },
    { name: "Consistency", score: consistencyScore, icon: Flame },
    { name: "Mission Balance", score: missionBalanceScore, icon: BarChart },
    ...
    <div className="mx-auto max-w-4xl py-8">
      ...
      <div className="glassmorphic rounded-xl p-6 mb-6 border border-primary/30">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <div className="flex items-baseline">
              <span className="text-white text-5xl font-mono">{healthPct}</span>
        ...
        <div className="flex justify-between mt-1">
          <span className="text-xs text-muted-foreground">Current: {healthPct}%</span>
