...
export default function CanvasesPage() {
  ...
  return <div className="container max-w-6xl py-6 space-y-5" data-testid="canvas-page">
    ...
    <div className="grid gap-2 sm:grid-cols-[1fr_180px]">
      <div className="relative"><Search className="absolute left-3 top-2.5 h-4 w-4 text-muted-foreground" /><Input aria-label="Search canvases" value={search} onChange={(event) => setSearch(event.target.value)} placeholder="Search canvases" className="pl-9" /></div>
