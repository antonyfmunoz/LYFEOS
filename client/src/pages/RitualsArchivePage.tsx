    ...
    <>
      ...
      <div className="mb-6 flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">Document your daily, weekly, and monthly practices</p>
        </div>
        <Button 
          ...
          {ritualCategories.map((category) => (
            <div key={category.frequency} className="glassmorphic rounded-xl overflow-hidden border border-slate-700/50">
              ...
              >
                ...
                <span className="text-xs text-muted-foreground px-2 py-1 bg-slate-800/50 rounded-full">
                ...
                <div className="px-4 pb-4 space-y-3 pt-2 border-t border-slate-700/50">
                  {category.entries.length > 0 ? (
                    ...
                    <div className="text-center py-6">
                      <p className="text-muted-foreground">No {category.frequency} rituals found.</p>
                    </div>
                  )}
                </div>
              )}
