...
export default function SpreadsheetEditorPage() {
  ...
  return <div data-testid="sheet-editor" className="container max-w-[1500px] py-5 space-y-4">
    ...
    <p className="text-[11px] leading-relaxed text-muted-foreground">The grid renders only the visible rows and columns plus a small safety margin, even at the 500-row × 100-column limit. Use arrow keys to move one cell at a time and Shift+Arrow to extend a selection; choose Extend and then a cell on touch devices. Undo and Redo retain up to 20 unsaved grid, tab, and chart changes on this device and reset after save, reload, or restore. Shift-click also selects a rectangular range for copy, formatting, or a chart. Number, percent, USD currency, text-color, and fill-color formats change display only; raw values and formula inputs remain authoritative. Formatting applies only to populated cells; clipboard and CSV/TSV transfer values and formulas, not presentation, while plain-text paste preserves existing destination formatting. Paste starts at the active cell and remains unsaved until you review and save. Insertions preserve populated cells, formatting, affected formula references, chart source alignment, and explicit combination-chart series roles. Formulas support cell references, arithmetic, parentheses, comparisons, quoted text, TRUE/FALSE, SUM, AVERAGE, MIN, MAX, COUNT, COUNTA, ROUND, ABS, and lazy IF branches. CSV export writes unformatted calculated formula results and protects text beginning with spreadsheet-executable prefixes.</p>
