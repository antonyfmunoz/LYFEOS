    ...
    <div className="dashboard-container">
      ...
      <section className="mb-6">
        ...
        <div className="relative pl-10 pr-2 py-2 max-h-96 overflow-y-auto mission-timeline-container">
          ...
          {/* Create missionCompletionStates as a state object to track completion */}
          {(() => {
            // Using a state for mission completion tracking
            const [missionCompletionStates, setMissionCompletionStates] = useState<Record<string, boolean>>({});
            
            // Toggle mission completion
            const toggleMission = (id: string) => {
              setMissionCompletionStates(prev => ({
                ...prev,
                [id]: !prev[id]
              }));
            };
            ...
            return (
              <>
                {events
                  ...
                  .map((event) => {
                    const isCompleted = missionCompletionStates[event.id] || false;
