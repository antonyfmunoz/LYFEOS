      ...
      <section className="mb-6">
        ...
        <div className="relative pl-10 pr-2 py-2 max-h-96 overflow-y-auto mission-timeline-container">
          ...
          {events
            ...
            .map((event, index) => (
              <div 
                key={event.id}
                className="mb-5 relative mission-block"
              >
                {/* Timeline Dot */}
                ...
                {/* Mission Card */}
                <div 
                  className="glassmorphic rounded-xl p-4 neon-border hover:shadow-[0_0_5px_rgba(0,224,255,0.3)] transition ml-2"
                >
        ...
        <div className="mt-4 flex justify-between items-center">
          <div className="text-xs text-[#7DAAB2] italic flex items-center">
            ...
            Read-only view of today's scheduled missions
          </div>
          <Button
            variant="outline"
