...
export default function EnergyDetailPage() {
  ...
  const efficiencyMetrics = [
    ...
    { name: "Consistency", score: consistencyScore, icon: Calendar, desc: "Daily streak consistency (streak / 30)" },
    { name: "Mission Balance", score: missionBalanceScore, icon: Layers, desc: "Category diversity (categories / 5)" },
  ];
            ...
            <div className="glassmorphic rounded-2xl p-6 mb-8 border border-primary/30">
              ...
              <ResponsiveContainer width="100%" height={250}>
                <BarChart data={tokenUtilization} margin={{ top: 5, right: 10, left: -10, bottom: 5 }}>
                  <defs>
                    <linearGradient id="energyTokenUsedGradient" x1="0" y1="0" x2="0" y2="1">
                  ...
                  />
                  <Bar dataKey="used" name="Used" stackId="tokens" fill="url(#energyTokenUsedGradient)" radius={[0, 0, 0, 0]} />
            ...
            <div className="glassmorphic rounded-2xl p-6 mb-8 border border-primary/30">
              ...
              <ResponsiveContainer width="100%" height={220}>
                <BarChart data={weekdayPatterns} margin={{ top: 5, right: 10, left: -10, bottom: 5 }}>
                  <defs>
                    <linearGradient id="energyWeekdayBarGradient" x1="0" y1="0" x2="0" y2="1">
                      <stop offset="0%" stopColor="hsl(var(--primary))" stopOpacity={0.9} />
                  ...
                  />
                  <Bar dataKey="completed" name="Missions" fill="url(#energyWeekdayBarGradient)" radius={[4, 4, 0, 0]} />
                </BarChart>
              </ResponsiveContainer>
