...
type CatalogLookup = { provider: { id: string; name: string; datasetVersion: string; attributionText: string; attributionUrl?: string | null }; item: { externalId: string; itemVersion: string; territory: string; name: string; brand?: string | null; barcode?: string | null; ingredientsText?: string | null; certifications: CatalogCertification[]; nutrients: Array<{ nutrientKey: string; amountPer100g: number; unit: string }>; lookupToken: string } | null; found: boolean; disclosure: string };
