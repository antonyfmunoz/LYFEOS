...
type Food = { id: number; name: string; brand: string | null; barcode: string | null; servingSizeGrams: number; densityGramsPerMl: number | null; favorite: boolean; note: string | null; recentUseCount: number; lastLoggedAt: string | null; nutrients: Nutrient[]; portions: FoodPortion[] };
