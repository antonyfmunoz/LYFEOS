                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3 flex-grow">
                    <div className="flex justify-between">
                      <h3 className={`font-orbitron text-base ${mission.completed ? 'line-through text-muted-foreground' : 'text-primary'}`}>
                        {mission.title}
                      </h3>
                    ...
                    <p className={`text-xs text-muted-foreground mt-0.5 ${mission.completed ? 'line-through' : ''}`}>
