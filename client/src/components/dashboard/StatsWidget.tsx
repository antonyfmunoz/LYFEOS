  ...
  return (
    <div className="glassmorphic rounded-xl p-4 neon-border">
      ...
      <div className="stat-block group hover:bg-primary/10 hover:border-primary/40 rounded-lg p-3 transition-all cursor-pointer border border-primary/20 mb-5 relative">
        <StatInfoDialog
          trigger={
            <button className="absolute top-3 right-3 p-1 rounded-full bg-primary/10 hover:bg-primary/20 transition-colors text-[#36F1CD]">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div className="stat-block group hover:bg-primary/10 hover:border-primary/40 rounded-lg p-3 transition-all cursor-pointer border border-primary/20 relative">
          <StatInfoDialog
            trigger={
              <button className="absolute top-3 right-3 p-1 rounded-full bg-primary/10 hover:bg-primary/20 transition-colors text-primary">
                <Info className="h-4 w-4" />
              </button>
            }
            title="Time Tokens"
        ...
        <div className="stat-block group hover:bg-primary/10 hover:border-primary/40 rounded-lg p-3 transition-all cursor-pointer border border-primary/20 relative">
          <StatInfoDialog
            trigger={
              <button className="absolute top-3 right-3 p-1 rounded-full bg-primary/10 hover:bg-primary/20 transition-colors text-[#FCD34D]">
                <Info className="h-4 w-4" />
              </button>
            }
            title="Energy Points"
        ...
        <div className="stat-block group hover:bg-primary/10 hover:border-primary/40 rounded-lg p-3 transition-all cursor-pointer border border-primary/20 relative">
          <StatInfoDialog
            trigger={
              <button className="absolute top-3 right-3 p-1 rounded-full bg-primary/10 hover:bg-primary/20 transition-colors text-[#EC4899]">
                <Info className="h-4 w-4" />
              </button>
            }
            title="Health Points"
