...
export function CustomTimePicker({ 
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {/* Dropdown picker */}
      {isOpen && (
        <div className="custom-time-picker-dropdown absolute top-full left-0 z-[9999] mt-1 p-4 bg-[#001824] border border-primary/30 rounded-md shadow-lg shadow-primary/10 w-64 glassmorphic neon-border animate-in fade-in-50 duration-100">
