...
As of 2026-08-30, Fly release 186 serves source `8fc791941dd4a828b5024db8969d49d6dc0b6612` from image `deployment-01M19NDJMS84TD62QM92ZTHKJ2` with digest `sha256:addeba144e9ab82420875c48ab4e733e792e97b44496efed78b5bc120674b6cf` and release ID `xabBGzjKK3Ob0TX0ZmZgpzq4`. Exact CI `33320223528` passed both required lanes, all 135 release migrations through `0143_cross_product_consent_lifecycle`, the authenticated and recovery journeys, collaboration, and deterministic logical backup/isolated restore. Monitor `33320582276` passed readiness, anonymous-auth isolation, immutable release/migration identity and protected Health integrity.
