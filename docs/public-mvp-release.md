...
As of 2026-08-30, Fly release 187 serves source `0d7c9fc88a6f08f62cb3ae93c76d47cc6dea5c72` from image `deployment-01M19PGE4JWTAGWWKQHACCNMDS` with digest `sha256:35a3d558b2f966caa21e5e0759c3e347ec7603cd59d9758d30792e9867b33133` and release ID `QgDeJ3o11V2D7fj4b3B5G2NA`. Exact CI `33321032203` passed both required lanes, all 135 release migrations through `0143_cross_product_consent_lifecycle`, the authenticated and recovery journeys, collaboration, and deterministic logical backup/isolated restore. Monitor `33321464976` passed readiness, anonymous-auth isolation, immutable release/migration identity and protected Health integrity.
