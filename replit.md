...
- **Onboarding Missions**: 8 missions (0-7) with step counts: M0(5), M1(variable archetype Qs), M2(21), M3(8), M4(12), M5(17), M6(5), M7(10). New steps added to collect: keyDrivers, careerVocation, activeVentures, collaborationStyle, roleOrientation, greatestContribution, trainingStyle, energyPatterns, longevityFocus, aesthetic, signatureExpression, creativeOutlets.
